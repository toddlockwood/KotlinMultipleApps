package sde.com.kotlinmultipleapps.adapters
...
import sde.com.kotlinmultipleapps.HappyPlacesApp.activities.AddHappyPlaceActivity
...
open class HappyPlacesAdapter(
    ...
    fun notifyEditItem(activity: Activity, position: Int, requestCode: Int) {
        ...
        intent.putExtra(HappyPlacesApp.EXTRA_PLACE_DETAILS, list[position])
