...
import sde.com.kotlinmultipleapps.HappyPlacesApp.utils.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(HappyPlacesApp.EXTRA_PLACE_DETAILS)){
            mHappyPlaceDetails = intent.getSerializableExtra(HappyPlacesApp.EXTRA_PLACE_DETAILS) as HappyPlaceModel
        }
        ...
        if (mHappyPlaceDetails != null) {
            ...
            mLati = mHappyPlaceDetails!!.latitude
            mLon = mHappyPlaceDetails!!.longitude
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            mLati = mLastLocation.latitude

            mLon = mLastLocation.longitude

            val addressTask =
                GetAddressFromLatLng(this@AddHappyPlaceActivity, mLati, mLon)
